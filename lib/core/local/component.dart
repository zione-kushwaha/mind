    ...
    children: [
      ...
      Positioned(
        ...
        child: IconButton(
          ...
          icon: const Icon(Icons.segment, size: 40, color: ColorManager.blue),
        ),
      ),
    ],
  );
...
Widget CustombackAppBar(BuildContext context, VoidCallback back) {
  return SafeArea(
    child: Stack(
      children: [
        Container(
    ...
    child: SafeArea(
      child: Column(
        children: [
              ...
              children: [
                Positioned(
                  ...
                  child: CircleAvatar(
                    ...
                    child: CircleAvatar(
                      radius: 48,
                      backgroundImage: NetworkImage("next"),
                    ),
                  ),
                ),
                Positioned(
          ...
          ListTile(
            onTap: tab2,
            leading: const Icon(Icons.hub_outlined, size: 30),
            title: const Text(
              'Centers',
              style: TextStyle(fontSize: 25, color: ColorManager.greyFont),
            ),
          ...
          ListTile(
            onTap: tab3,
            leading: const Icon(Icons.receipt_long_sharp, size: 30),
            title: const Text(
              'Reports',
              style: TextStyle(fontSize: 25, color: ColorManager.greyFont),
            ),
          ...
          ListTile(
            onTap: tab4,
            leading: const Icon(Icons.feedback_outlined, size: 30),
            title: const Text(
              'FeedBack',
              style: TextStyle(fontSize: 25, color: ColorManager.greyFont),
            ),
