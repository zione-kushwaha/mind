...
class SchoolTest extends StatefulWidget {
  static const String routeName = '/school_test';
...
class _SchoolTestState extends State<SchoolTest>
  ...
  final List<WordFindQues> listQuestions = [
    ...
    WordFindQues(
      ...
      answer: "bus",
      image: "assets/image/school_bus.png",
    ),
    WordFindQues(
      question: "Who teaches in the school?",
      answer: "teacher",
...
class _WordFindWidgetState extends State<WordFindWidget> {
  ...
  void initState() {
    ...
    generatePuzzle();
    initTts();
    _speak("Welcome to the school test");
  }
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    icon: Icon(Icons.volume_up, color: Colors.red[700]),
                  ),
                ],
              ),
            ],
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: isUsed ? Colors.grey[300] : Colors.red,
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(10),
                    ),
                    elevation: 3,
  ...
  List<String> _generateExtraLetters(int answerLength) {
    // Generate some random letters to fill out the puzzle
      ...
      currentQues.puzzles =
          currentQues.puzzles.map((puzzle) {
            ...
            if (indexHint == countTemp - 1) {
              ...
              // Find the first available instance of the correct letter
