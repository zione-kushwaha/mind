...
class ColorTest extends StatefulWidget {
  static const String routeName = '/color_test';
...
class _WordFindWidgetState extends State<WordFindWidget> {
  ...
  void initState() {
    ...
    generatePuzzle();
    initTts();
    _speak("Welcome to the colors test");
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    icon: Icon(Icons.volume_up, color: Colors.cyan[700]),
                  ),
                ],
              ),
            ],
        ...
        // Image section with color background
        Expanded(
          flex: 2,
          child: Container(
            ...
            child: Card(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: _getColorFromName(currentQues.answer ?? ''),
                  borderRadius: BorderRadius.circular(15),
                ),
                child:
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: isUsed ? Colors.grey[300] : Colors.cyan,
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(10),
                    ),
                    elevation: 3,
