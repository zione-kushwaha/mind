...
class Puzzle extends Equatable {
  ...
  Puzzle move(Tile tile) {
    ...
    return Puzzle._(
      ...
      image: image, // Use the provided image directly
  ...
  factory Puzzle.create(
    int crossAxisCount, {
    required List<Uint8List> segmentedImage,
    required EmotionImage image,
  }) {
    int value = 1;
    final tiles = <Tile>[];
  ...
  Puzzle shuffle() {
    ...
    if (_isSolvable(values)) {
      int x = 1, y = 1;
      Position emptyPosition = Position(x: 1, y: 1); // Default initialization
      final copy = [...tiles];
  ...
  @override
  List<Object> get props => [tiles, emptyPosition, image, segmentedImage];
}
