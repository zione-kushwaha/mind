...
class _PuzzleTileState extends State<EmotionTile>
  ...
  void initState() {
    ...
    _angle = TweenSequence<double>([
      TweenSequenceItem(
        tween: Tween(begin: 0, end: 180 * math.pi / 180),
        weight: 0.1,
      ),
      TweenSequenceItem(
        tween: Tween(begin: 180 * math.pi / 180, end: 180 * math.pi / 180),
        weight: 0.2,
      ),
      TweenSequenceItem(
        tween: Tween(begin: 180 * math.pi / 180, end: 270 * math.pi / 180),
        weight: 0.1,
      ),
      TweenSequenceItem(
        tween: Tween(begin: 270 * math.pi / 180, end: 0),
        weight: 0.1,
      ),
    ]).animate(_controller);
    ...
    return AnimatedPositioned(
      ...
      child: GestureDetector(
        ...
        child: AnimatedBuilder(
          ...
          builder:
              (_, child) => Transform(
                transform: Matrix4.identity()..rotateY(_angle.value),
          ...
          child: ClipRRect(
            child: Container(
              ...
              child: AnimatedSwitcher(
                duration: const Duration(milliseconds: 200),
                child: Stack(
                  key: Key(widget.imageTile.hashCode.toString()),
                  children: [
                    Positioned.fill(
                      child: Image.asset(widget.imageTile, fit: BoxFit.fill),
                    ),
