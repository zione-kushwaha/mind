...
List<EmotionImage> puzzleOptions = <EmotionImage>[
  ...
  const EmotionImage(
    ...
    soundPath: 'assets/sounds/happy.mp3',
    gifPath: 'assets/images/happy.gif',
  ),
  const EmotionImage(
    name: 'Sad',
    assetPath: 'assets/images/Sad.png',
    soundPath: 'assets/sounds/sad.mp3',

    gifPath: 'assets/images/Sad_2.gif',
  ),
  const EmotionImage(
    name: 'Angry',
    assetPath: 'assets/images/Angry.png',
    soundPath: 'assets/sounds/Angry.mp3',
    gifPath: 'assets/images/Angry2.gif',
  ),
  const EmotionImage(
    name: 'Cry',
    assetPath: 'assets/images/Cry.png',
    soundPath: 'assets/sounds/crying.mp3',
    gifPath: 'assets/images/Cry_1.gif',
  ),
  const EmotionImage(
    name: 'Surprised',
    assetPath: 'assets/images/Surprised.png',
    soundPath: 'assets/sounds/surprised.mp3',
    gifPath: 'assets/images/Surprised.gif',
  ),
  const EmotionImage(
    name: 'Funny',
    assetPath: 'assets/images/Funny.png',
    soundPath: 'assets/sounds/funny.mp3',
    gifPath: 'assets/images/Funny_1.gif',
  ),
  const EmotionImage(
    name: 'Calm',
    assetPath: 'assets/images/Calim.png',
    soundPath: 'assets/sounds/calm.mp3',
    gifPath: 'assets/images/Calim.gif',
  ),
  const EmotionImage(
    name: 'Frighten',
    assetPath: 'assets/images/Frighten.png',
    soundPath: 'assets/sounds/frightened.mp3',
    gifPath: 'assets/images/Frighten.gif',
  ),
];

Image decodeAsset(ByteData bytes) {
  final decodedImage = decodeImage(bytes.buffer.asUint8List());
...
class ImagesRepositoryImpl implements ImagesRepository {
  ...
  Future<List<Uint8List>> split(String asset, int crossAxisCount) async {
    ...
    final pieces = await compute(splitImage, SPlitData(image, crossAxisCount));
