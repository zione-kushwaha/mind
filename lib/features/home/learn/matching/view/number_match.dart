...
class _NumbersMatchState extends State<NumbersMatch>
  ...
  void initGame() {
    ...
    items = [
      ...
      ItemModel(
        value: 'fox',
        name: 'fox',
        img: 'assets/match_images/10.png',
    ...
    reverseItems = [
      ...
      ItemModel(
        value: 'fox',
        name: 'fox',
        img: 'assets/match_images/100.png',
        color: Colors.red[600]!,
      ),
      ItemModel(
        value: 'goat',
  ...
  Widget _buildGameArea() {
    return Column(
      children: [
        ...
        SizedBox(height: 10),
        Text(
          'Drag the items to match the numbers',
          style: TextStyle(
            fontSize: 18,
        ...
        Padding(
          ...
          child: Text(
            'Drag the items to match the numbers with their representations!',
  ...
  String _getResultMessage() {
    if (score == 60) {
      ...
      return 'Perfect! You matched all numbers correctly! 🎉';
    } else if (score >= 30) {
      player.play(AssetSource('success.wav'));
      return 'Great job! You know your numbers well! 😊';
    } else {
      player.play(AssetSource('tryAgain.wav'));
      return 'Nice try! Keep practicing your numbers! 💪';
    }
  }
}
