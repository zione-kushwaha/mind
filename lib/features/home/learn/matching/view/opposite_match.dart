...
class _OppositeMatchState extends State<OppositeMatch>
  ...
  void initGame() {
    ...
    items = [
      ...
      ItemModel(
        value: 'Clean',
        name: 'Clean',
        img: 'assets/match_images/clean.png',
    ...
    reverseItems = [
      ...
      ItemModel(
        value: 'Clean',
        name: 'Dirty',
        img: 'assets/match_images/dirty.png',
        color: Colors.green[600]!,
      ),
      ItemModel(
        value: 'Open',
  ...
  Widget _buildGameArea() {
    return Column(
      children: [
        ...
        SizedBox(height: 10),
        Text(
          'Drag the items to their opposites',
          style: TextStyle(
            fontSize: 18,
        ...
        Padding(
          ...
          child: Text(
            'Drag the items to match with their opposites!',
  ...
  String _getResultMessage() {
    if (score == 70) {
      ...
      return 'Perfect! You matched all opposites correctly! 🎉';
    } else if (score >= 40) {
      player.play(AssetSource('success.wav'));
      return 'Great job! You know your opposites well! 😊';
    } else {
      player.play(AssetSource('tryAgain.wav'));
      return 'Nice try! Keep practicing your opposites! 💪';
    }
  }
}
